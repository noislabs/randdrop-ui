  ...
  return (
    <>
      <button
        ...
        className="flex justify-center items-center w-[30vw] md:w-[20vw] lg:w-[10vw] h-full rounded-lg px-3 py-1.5 border-1 border-nois-light-green/30 text-nois-light-green/80 hover:text-nois-light-green hover:border-nois-light-green hover:bg-black"
      >
        {walletLoading ? (
          <DotLoader/>
        ):(
          <span className="w-full text-sm overflow-hidden overflow-ellipsis">
...
export const WalletConnectModalOld = () => {
