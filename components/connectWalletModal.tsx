...
import { WalletType, useAllMultiClients } from "../contexts/userClients";
  ...
  return (
    <>
      <button
        ...
        className="flex justify-center items-center rounded-xl px-4 py-2 border border-nois-light-green/30 text-nois-light-green/80 hover:text-nois-light-green hover:border-nois-light-green hover:bg-black"
      >
        {walletLoading ? (
          <DotLoader />
        ) : (
      ...
      {isOpen && (
        ...
        >
          <div className="flex items-center md:items-end justify-center min-h-screen pt-4 px-4 pb-20 text-center sm:block sm:p-0">
            ...
            <div
              ref={modalRef}
              className="inline-block h-[60vh] w-[90vw] rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-lg sm:w-full"
            >
              <div className="bxg-gray-950 bg-neutral-900 brightness-110 pt-2 pb-2 h-full flex flex-col px-4 pt-5pb-4sm:p-6sm:pb-4">
                <div className="w-full flex justify-between items-center">
                  <div
                    className="text-lg px-1 font-thin text-nois-white/40"
                    id="modal-title"
                  >
                    Connect Wallet
                  </div>
                  <svg
                    ...
                    strokeWidth={1.5}
                    stroke="currentColor"
                    className="hover:cursor-pointer opacity-50 hover:opacity-100 w-6 h-6"
                  >
                    <path
                      strokeLinecap="round"
                ...
                <div className="grid grid-rows-4 h-full py-2 gap-y-2">
                  <div
                    ...
                    className={`row-span-1 h-full py-1 flex justify-center md:justify-start rounded-lg hover:cursor-pointer ${
                      checked === "keplr"
                      ...
                      <div className="relative aspect-square">
                        <NextImage
                          ...
                          className={`roundexd-full ${
                            checked !== "keplr" &&
                            "saturdate-50 grayscale brightness-[0.3]"
                          }`}
                        />
                      </div>
                    </div>
                    ...
                    <div className="basis-0 md:basis-1/3 h-full hidden md:flex justify-center p-2">
                      <div className="relative aspect-square">
                        <NextImage
                          ...
                          object-fit="cover"
                          fill={true}
                          className={`border border-nois-white/50 ${
                            checked !== "ledger" &&
                            "saturdate-50 grayscale brightness-[0.3]"
                          }`}
                        />
                ...
                <div className="flex justify-end items-center w-full p-2">
                  <button
                    ...
                    className={`border rounded-lg py-2 px-8 ${
                      !checked
                  ...
                  >
                    {`Connect ${
                      checked
                        ? checked &&
                          checked.charAt(0).toUpperCase() + checked.slice(1)
                        : ""
                    }`}
                  </button>
                </div>
