...
// export const NoisFooter = () => {
//   return (
//     <footer className="relative flex h-[15vh] w-full items-center justify-center">
//       <div className="absolute left-8 text-sm text-left text-nois-white/80 self-center">
//         {`**Eligible users have a 1/3 chance of winning`}
//       </div>
//       <div className="flex gap-x-6">
//       <a
